...
namespace Modules.Resources
{
    public class DataProvider
    {
        ...
        private IntStorage<string>    _intStorage    ;
        private FloatStorage<string>  _floatStorage  ;
        private StringStorage<string> _stringStorage ;
        
        public DataProvider(SaveAndLoadProvider saveAndLoadProvider, ResourceSettings resourceSettings)
        {
            _intStorage = new IntStorage<string>     { Prefix = saveAndLoadProvider.CurrentSaveName};
            _floatStorage = new FloatStorage<string> { Prefix = saveAndLoadProvider.CurrentSaveName };
            _stringStorage = new StringStorage       { Prefix = saveAndLoadProvider.CurrentSaveName };
