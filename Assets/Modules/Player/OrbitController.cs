...
namespace Modules.Game.Player
{
    public class OrbitController : MonoBehaviour
    {
        ...
        [SerializeField]
        private float speed, radius, t;
        private Transform _enteredItem;
        private bool _onTheOrbit;
        ...
        {
            if (IsInLayerMask(other.gameObject, _orbitLayerMask)) _enteredItem = other.transform;
        }

        private void OnTriggerExit2D(Collider2D other)
        {
            if (other.gameObject.transform == _enteredItem) _enteredItem = null;
        }
